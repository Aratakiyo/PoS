...
export default function Terminal() {
  return (
    <div className="max-w-full h-1/5 rounded-xl bg-sky-950 text-white text-lg mt-2">
      <div className="flex justify-between">
        <div className="font-bold text-3xl py-3 px-5 mt-4">
          <p>Employer Transactions</p>
        </div>
        <Link href="/">
          <button className="bg-red-400 rounded-xl py-3 px-5 mr-5 mt-5 hover:font-bold hover:bg-red-500 text-m">
            Back
          </button>
        </Link>
      </div>
      <div className="flex">
        ...
        <form className="flex w-1/2 p-5 space-x-9 pb-7">
